"""sci_test_sp_pipeline.py tests the complete integrity of the mp pipeline.
...
=======
>>> python -m unittest sci_test_sp_pipeline
...
class SPpipelineFullrunDHFRTestCase(unittest.TestCase):
    ...
    >>> python -m unittest sci_test_sp_pipeline.SPpipelineFullrunDHFRTestCase.test_fullrun_rosettamutfile_prov_flag
    """
    ...
    def test_a_fullrun_rosettamutfile_prov_flag(self):
        ...
        self.reference_dir = data('sp-pipeline/output/SPpipelineFullrunDHFRTestCase_rosettamutfile')
    ...
    def test_b_analyze_exp_rosettamutfile_prov_flag(self):
        self.output_dir = tmp('fullrun_rosettamutfile_DHFR_prov_flag')
        self.reference_dir_in = data('sp-pipeline/input')
        ...
        correlation_list_file = os.path.join(self.reference_dir_out, 'DHFR_cutoffs.txt')
        ...
        prism_file_exp = os.path.join(self.reference_dir_in, 'prism_merged_files.txt')#'prism_merged_XXX_DHFR_ecoli.txt')
