...
parser.add_argument('-tmp_folder', dest='tmp_folder', help="Where the temporary step 1 files are stored. Default location is /storage1/hezscha/gnomad_to_prism_parser/step1_files/+[chromosome] derived from looking up each transcript on ensembl")
parser.add_argument('-out_folder', dest='out_folder', help="Where the output files should be written. Default location is /storage1/shared/data/prism/uniprotID[0:2]/uniprotID[2:4]/uniprotID[4:6]/")
